...
"        fmap (, 0) $ AUX_NGX.evaluate AUX_NGX.$!! s\n"
...
"    (do\n"
"        (s, (r, exiting)) <- aux_ngx_safeAsyncYYHandler $ do\n"
"            (s, exiting) <- a\n"
"            AUX_NGX.interruptible $ fmap (, (0, exiting)) $\n"
"                AUX_NGX.evaluate AUX_NGX.$!! s\n"
"        aux_ngx_pokeLazyByteString s p pl spd\n"
"        AUX_NGX.poke pr r\n"
"        if exiting\n"
...
"    (do\n"
"        x' <- AUX_NGX_BS.unsafePackCStringLen (x, n)\n"
"        (s, ct, fromIntegral -> st, rhs) <- AUX_NGX.interruptible $ do\n"
"            v <- f x'\n"
"            AUX_NGX.evaluate AUX_NGX.$!! v\n"
...
"        lct <- (AUX_NGX.evaluate AUX_NGX.$!! v) >>\n"
