...
"IO AUX_NGX.CInt; \\\n"
"type_ngx_hs_ ## F = aux_ngx_exportType $ AUX_NGX_S_S F; \\\n"
...
"type_ngx_hs_ ## F = aux_ngx_exportType $ AUX_NGX_S_SS F; \\\n"
"foreign export ccall type_ngx_hs_ ## F :: IO AUX_NGX.CInt\n\n"
...
"\\\n    AUX_NGX.Ptr AUX_NGX.CString -> IO AUX_NGX.CInt; \\\n"
"type_ngx_hs_ ## F = aux_ngx_exportType $ AUX_NGX_S_LS F; \\\n"
"foreign export ccall type_ngx_hs_ ## F :: IO AUX_NGX.CInt\n\n"
"#define NGX_EXPORT_B_S(F) \\\n"
"ngx_hs_ ## F = aux_ngx_hs_b_s $ AUX_NGX_B_S F; \\\n"
"foreign export ccall ngx_hs_ ## F :: \\\n    "
"AUX_NGX.CString -> AUX_NGX.CInt -> \\\n    IO AUX_NGX.CUInt; \\\n"
"type_ngx_hs_ ## F = aux_ngx_exportType $ AUX_NGX_B_S F; \\\n"
"foreign export ccall type_ngx_hs_ ## F :: IO AUX_NGX.CInt\n\n"
...
"AUX_NGX.CString -> AUX_NGX.CInt -> \\\n    AUX_NGX.CString -> AUX_NGX.CInt -> "
"\\\n    IO AUX_NGX.CUInt; \\\n"
"type_ngx_hs_ ## F = aux_ngx_exportType $ AUX_NGX_B_SS F; \\\n"
"foreign export ccall type_ngx_hs_ ## F :: IO AUX_NGX.CInt\n\n"
"#define NGX_EXPORT_B_LS(F) \\\n"
"ngx_hs_ ## F = aux_ngx_hs_b_ls $ AUX_NGX_B_LS F; \\\n"
"foreign export ccall ngx_hs_ ## F :: \\\n    "
"AUX_NGX.Ptr AUX_NGX_STR_TYPE -> AUX_NGX.CInt -> \\\n    IO AUX_NGX.CUInt; \\\n"
"type_ngx_hs_ ## F = aux_ngx_exportType $ AUX_NGX_B_LS F; \\\n"
"foreign export ccall type_ngx_hs_ ## F :: IO AUX_NGX.CInt\n\n"
...
"AUX_NGX.CString -> AUX_NGX.CInt -> \\\n    AUX_NGX.Ptr AUX_NGX.CString -> "
"IO AUX_NGX.CInt; \\\n"
"type_ngx_hs_ ## F = aux_ngx_exportType $ AUX_NGX_Y_Y F; \\\n"
"foreign export ccall type_ngx_hs_ ## F :: IO AUX_NGX.CInt\n\n"
"#define NGX_EXPORT_B_Y(F) \\\n"
"ngx_hs_ ## F = aux_ngx_hs_b_y $ AUX_NGX_B_Y F; \\\n"
"foreign export ccall ngx_hs_ ## F :: \\\n    "
"AUX_NGX.CString -> AUX_NGX.CInt -> \\\n    IO AUX_NGX.CUInt; \\\n"
"type_ngx_hs_ ## F = aux_ngx_exportType $ AUX_NGX_B_Y F; \\\n"
"foreign export ccall type_ngx_hs_ ## F :: IO AUX_NGX.CInt\n\n"
...
"type_ngx_hs_ ## F = aux_ngx_exportType $ AUX_NGX_HANDLER F; \\\n"
"foreign export ccall type_ngx_hs_ ## F :: IO AUX_NGX.CInt\n\n"
...
"\\\n    AUX_NGX.Ptr AUX_NGX.CString -> AUX_NGX.Ptr AUX_NGX.CSize -> "
"\\\n    IO AUX_NGX.CInt; \\\n"
"type_ngx_hs_ ## F = aux_ngx_exportType $ AUX_NGX_UNSAFE_HANDLER F; \\\n"
"foreign export ccall type_ngx_hs_ ## F :: IO AUX_NGX.CInt\n\n"
...
"    fromEnum (AUX_NGX_UNSAFE_HANDLER _) = 10\n\n"
