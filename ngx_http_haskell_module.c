...
"    foldr (\\k -> ((AUX_NGX.peekElemOff x k >>= (\\(AUX_NGX_STR_TYPE m y) -> "
"AUX_NGX.peekCStringLen (y, fromIntegral m))) :)) [] [0 .. n - 1]\n\n"
"aux_ngx_hs_s_s :: AUX_NGX_EXPORT -> AUX_NGX.CString -> AUX_NGX.CInt -> "
"AUX_NGX.Ptr AUX_NGX.CString -> IO AUX_NGX.CInt\n"
"aux_ngx_hs_s_s (AUX_NGX_S_S f) x (fromIntegral -> n) p = do\n"
"    (s, fromIntegral -> l) <- AUX_NGX.liftM f (AUX_NGX.peekCStringLen (x, n)) "
">>= AUX_NGX.newCStringLen\n"
"    AUX_NGX.poke p s\n"
"    return l\n"
"aux_ngx_hs_s_ss :: AUX_NGX_EXPORT -> AUX_NGX.CString -> AUX_NGX.CInt -> "
"AUX_NGX.CString -> AUX_NGX.CInt -> AUX_NGX.Ptr AUX_NGX.CString -> "
"IO AUX_NGX.CInt\n"
"aux_ngx_hs_s_ss (AUX_NGX_S_SS f) x (fromIntegral -> n) y (fromIntegral -> m) "
"p = do\n"
"    (s, fromIntegral -> l) <- AUX_NGX.liftM2 f "
"(AUX_NGX.peekCStringLen (x, n)) (AUX_NGX.peekCStringLen (y, m)) >>= "
"AUX_NGX.newCStringLen\n"
"    AUX_NGX.poke p s\n"
"    return l\n"
"aux_ngx_hs_s_ls :: AUX_NGX_EXPORT -> AUX_NGX.Ptr AUX_NGX_STR_TYPE -> "
"AUX_NGX.CInt -> AUX_NGX.Ptr AUX_NGX.CString -> IO AUX_NGX.CInt\n"
"aux_ngx_hs_s_ls (AUX_NGX_S_LS f) x (fromIntegral -> n) p = do\n"
"    (s, fromIntegral -> l) <- AUX_NGX.liftM f "
"(aux_ngx_peekNgxStringArrayLen x n) >>= AUX_NGX.newCStringLen\n"
"    AUX_NGX.poke p s\n"
"    return l\n"
...
"    AUX_NGX.when mallocSuccess $ AUX_NGX.void $ AUX_NGX_BSL.foldlChunks\n"
"        (\\a s -> do\n"
"            off <- a\n"
"            let l = AUX_NGX_BS.length s\n"
"            AUX_NGX_BS.unsafeUseAsCString s $ flip (AUX_NGX.copyBytes $ "
"AUX_NGX.plusPtr t off) l\n"
"            return $ off + l\n"
"        ) (return 0) s\n"
"    AUX_NGX.poke p t\n"
"    return $ if mallocSuccess then fromIntegral l else 0\n\n"
"aux_ngx_hs_b_s :: AUX_NGX_EXPORT -> AUX_NGX.CString -> AUX_NGX.CInt -> "
"IO AUX_NGX.CUInt\n"
"aux_ngx_hs_b_s (AUX_NGX_B_S f) x (fromIntegral -> n) =\n"
"    AUX_NGX.liftM (fromIntegral . fromEnum . f) $ "
"AUX_NGX.peekCStringLen (x, n)\n"
"aux_ngx_hs_b_ss :: AUX_NGX_EXPORT -> AUX_NGX.CString -> AUX_NGX.CInt -> "
"AUX_NGX.CString -> AUX_NGX.CInt ->  IO AUX_NGX.CUInt\n"
"aux_ngx_hs_b_ss (AUX_NGX_B_SS f) x (fromIntegral -> n) y "
"(fromIntegral -> m) =\n"
"    AUX_NGX.liftM2 (((fromIntegral .) fromEnum .) . f) "
"(AUX_NGX.peekCStringLen (x, n)) $ AUX_NGX.peekCStringLen (y, m)\n"
"aux_ngx_hs_b_ls :: AUX_NGX_EXPORT -> AUX_NGX.Ptr AUX_NGX_STR_TYPE -> "
"AUX_NGX.CInt -> IO AUX_NGX.CUInt\n"
"aux_ngx_hs_b_ls (AUX_NGX_B_LS f) x (fromIntegral -> n) =\n"
"    AUX_NGX.liftM (fromIntegral . fromEnum . f) $ "
"aux_ngx_peekNgxStringArrayLen x n\n"
