...
"    (s, r) <- aux_ngx_safeYYHandler $\n"
"        flip (,) 0 . f <$> AUX_NGX_BS.unsafePackCStringLen (x, n)\n"
...
"                  )\n"
"              ) 0\n"
"          writeFlag1b = AUX_NGX_BS.unsafeUseAsCString aux_ngx_asyncIOFlag1b $"
"\n"
"               writeBufN 1\n"
"          writeFlag8b = AUX_NGX_BS.unsafeUseAsCString aux_ngx_asyncIOFlag8b $"
"\n"
"               writeBufN 8\n\n"
...
"                           `AUX_NGX.catches`\n"
"                           [AUX_NGX.Handler\n"
"                                ((\\e -> return (not (aux_ngx_isEINTR e),\n"
"                                                False)\n"
"                                 ) :: AUX_NGX.IOError -> IO (Bool, Bool))\n"
"                           ,AUX_NGX.Handler\n"
"                                ((\\e -> return (True,\n"
"                                                e == AUX_NGX.ThreadKilled)\n"
"                                 ) :: AUX_NGX.AsyncException -> IO (Bool, Bool"
"))\n"
"                           ]\n"
"                       else return False\n"
"        if exiting\n"
